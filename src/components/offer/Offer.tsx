      ...
      <div className="offer-wrapper" style={offerStyles.wrapper(props)}>
        ...
        >
          ...
          <div style={offerStyles.description} className="description">
            <p style={{ margin: 0, height: "56px" }}>- {offerGenerated.features[0]}</p>
            <p style={{ margin: 0, height: "56px" }}>- {offerGenerated.features[1]}</p>
            <p style={{ margin: 0, height: "56px" }}>- {offerGenerated.features[2]}</p>
          </div>
