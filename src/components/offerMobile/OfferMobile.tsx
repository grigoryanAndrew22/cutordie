...
export const OfferMobile = (props: any) => {
  const offerGenerated = props.language === 'en' ? offerMobTextLangs.en : offerMobTextLangs.ua;
  ...
  return (
    <Fragment>
      <div className="offer-wrapper-mobile" style={offerMobileStyles.wrapper()}>
        ...
        <div className="cards" style={{ position: 'relative', margin: '54px 0px' }}>
          <Card
            position={'absolute'}
        ...
        >
          ...
          >
            <span style={offerMobileStyles.price} className="price">
              {currencyGenerated[0]}
              {currencyGenerated === offerCurrencies.uah && (
                <img width={36} src={uahSymbol} style={{ paddingLeft: '3px' }} />
              )}
            </span>
            <span style={offerMobileStyles.price} className="prev-price-mobile">
              {currencyGenerated[1]}
              {currencyGenerated === offerCurrencies.uah && (
                <img width={33} src={uahSymbol} style={{ paddingLeft: '2px' }} />
              )}
            </span>
          </div>
        </div>
